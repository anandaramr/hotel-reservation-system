        ...
        <div className ="h-[30svh]">
            <div className="border-2 border-white grid grid-cols-5 p-3 text-2xl text-center gap-3 rounded-md h-[10svh] font-amsterdam cursor-default select-none">
                ...
                <div className="col-start-1 col-span-2">
                    <div onClick={()=> setCounter(1)} className="col-start-1 col-span-2 flex flex-row rounded-lg justify-between bg-rose-50 items-center p-2 w-96">
                ...
                <div className="col-start-3 col-span-2">
                    <div onClick={()=> setCounter(2)} className="col-start-3 col-span-2 rounded-lg flex flex-row justify-between bg-rose-50 items-center p-2 w-96">
