                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        <div className="w-[40%] border-cyan-400 border-2 rounded-md py-2 px-5 flex flex-col">
                            ...
                            <div className="flex flex-wrap justify-between">
                                <div>{starterItems.map((item,index)=><p key={index} className="font-sora">{item}</p>)}</div>
                                <div>{starterPrices.map((price,index)=><p key={index} className="font-sora">₹{price}</p>)}</div>
                            </div>
                        </div>
                        ...
                        <div className="w-[40%]  border-cyan-400 border-2 rounded-md py -2 px-5">
                            ...
                            <div className="flex flex-wrap justify-between">
                                <div>{soupItems.map((item,index)=><p key={index} className="font-sora">{item}</p>)}</div>
                                <div>{soupPrices.map((price,index)=><p key={index} className="font-sora">₹{price}</p>)}</div>
                            </div>
                        </div>
                        ...
                        <div className="w-[40%]  border-cyan-400 border-2 rounded-md py-2 px-5">
                            ...
                            <div className="flex flex-wrap justify-between">
                                <div>{saladItems.map((item,index)=><p key={index} className="font-sora">{item}</p>)}</div>
                                <div>{saladPrices.map((price,index)=><p key={index} className="font-sora">₹{price}</p>)}</div>
                            </div>
                        </div>
                        ...
                        <div className="w-[40%]  border-cyan-400 border-2 rounded-md py-2 px-5">
                            ...
                            <div className="flex flex-wrap justify-between">
                                <div>{breadItems.map((item,index)=><p key={index} className="font-sora">{item}</p>)}</div>
                                <div>{breadPrices.map((price,index)=><p key={index} className="font-sora">₹{price}</p>)}</div>
                            </div>
                        </div>
                        ...
                        <div className="w-[40%]  border-cyan-400 border-2 rounded-md py-2 px-5">
                            ...
                            <div className="flex flex-wrap justify-between">
                                <div>{riceItems.map((item,index)=><p key={index} className="font-sora">{item}</p>)}</div>
                                <div>{ricePrices.map((price,index)=><p key={index} className="font-sora">₹{price}</p>)}</div>
                            </div>
                        </div>
                        ...
                        <div className="w-[40%]  border-cyan-400 border-2 rounded-md py-2 px-5">
                            ...
                            <div className="flex flex-wrap justify-between">
                                <div>{dessertItems.map((item,index)=><p key={index} className="font-sora">{item}</p>)}</div>
                                <div>{dessertPrices.map((price,index)=><p key={index} className="font-sora">₹{price}</p>)}</div>
                            </div>
                        </div>
                        ...
                        <h2 className="text-3xl font-semibold m-2">Beverages</h2>
                            <div className="flex flex-wrap justify-between">
                                <div>{beverageItems.map((item,index)=><p key={index} className="font-sora">{item}</p>)}</div>
                                <div>{beveragePrices.map((price,index)=><p key={index} className="font-sora">₹{price}</p>)}</div>
                            </div>
                        </div>
